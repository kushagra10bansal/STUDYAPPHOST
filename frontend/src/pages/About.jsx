      ...
      <section>
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
          <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
            <div className="my-24 flex lg:w-[50%] flex-col gap-10">
              <h1 className="bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%] ">
                One of our courses - WEB DEVELOPMENT BOOTCAMP
              </h1>
              <p className=" font-medium text-richblack-100 lg:w-[95%]">
              <h2>Build fullstack React.js applications with Node.js, Express.js & MongoDB (MERN) with this project-focused course.</h2>
              ...
              HTML, CSS, JavaScript,Tailwind CSS,CSS Animations,Core JavaScript,End to End React.js Application,15+ Industry Grade Projects,No Pre requisite required,End to End Backend with Node.js and Express.js,Building all Project from absolute Scratch    </p>
              <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
                PRICE: 3500 INR
                <h3>-No Prerequisite Required</h3>

<h3>-150 Hours On Demand Video</h3>

<h3>-MERN Stack Beginner to Advanced</h3>

<h3>-Industry Grade Projects</h3>
              </p>
            </div>
